...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(_translate("Dialog", "<html><head/><body>Special features:<ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 0;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:15px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Data from metadata tables can be referenced with <span style=\" font-family:\'Hack\';\">[id]:[field]</span>.</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:15px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Plugin data can be requested with <span style=\" font-family:\'Hack\';\">[plugin]:[arg1],[arg2],...,[kwarg1_key]=[kwarg1_value],...</span>. The colon has to be present even if no arguments are given. See the documentation for built-in plugins.</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:15px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Metadata fields containing timed data can be merged together using a <span style=\" font-family:\'Hack\';\">+</span>, e.g. <span style=\" font-family:\'Hack\';\">%(0_lyrics)s+%(0_chapters)s</span> to merge lyrics and chapters into one LRC string</li></ul></body></html>"))
        ...
        self.label_4.setText(_translate("Dialog", "<html><head/><body><p>Plugins for file modification can be requested with <span style=\" font-family:\'Hack\';\">[plugin]:[arg1],[arg2],...,[kwarg1_key]=[kwarg1_value],...</span>. The colon has to be present even if no arguments are given. See the documentation for built-in plugins.</p></body></html>"))
