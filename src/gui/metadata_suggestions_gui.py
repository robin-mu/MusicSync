...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.label_2, 4, 0, 1, 6)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "External metadata tables:"))
        ...
        self.label_2.setText(_translate("Dialog", "<html><head/><body>Special features:<ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 15px; margin-right: 0px; -qt-list-indent: 0;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">If a suggestion contains &quot;EXT_LYRICS:[format]&quot;, lyrics will be downloaded from external sources (syncedlyrics module) using [format] as the search term.</li><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">In fields containing timed data, a suggestion ending with &quot;+multi_video:[format]&quot; will have data from the individual videos of multi_video-type videos added into the field using [format]</li></ul></body></html>"))
        ...
        self.tag_combobox.setItemText(36, _translate("Dialog", "title"))
        self.tag_combobox.setItemText(37, _translate("Dialog", "title-sort"))
        self.tag_combobox.setItemText(38, _translate("Dialog", "tracknumber"))
        self.tag_combobox.setItemText(39, _translate("Dialog", "URL"))
        self.tag_combobox.setItemText(40, _translate("Dialog", "work"))
        self.label_4.setText(_translate("Dialog", "<html><head/><body>Special features:<ul style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 15px; margin-right: 0px; -qt-list-indent: 0;\"><li style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Metadata fields containing timed data can be merged together using a &quot;+&quot;, e.g. %(0_lyrics)s+%(0_chapters)s to merge lyrics and chapters into one LRC string</li></ul></body></html>"))
