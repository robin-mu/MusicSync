...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.external_table_add_button = QtWidgets.QToolButton(parent=self.frame)
        icon = QtGui.QIcon.fromTheme("list-add")
        ...
        self.external_table_remove_button = QtWidgets.QToolButton(parent=self.frame)
        icon = QtGui.QIcon.fromTheme("list-remove")
        ...
        self.external_tables_table = QtWidgets.QTableView(parent=self.frame)
